...
@MainActor class AuthenticationRegistrationViewModel: AuthenticationRegistrationViewModelType, AuthenticationRegistrationViewModelProtocol {
    ...
    init(homeserverAddress: String, ssoIdentityProviders: [SSOIdentityProvider]) {
        ...
        let viewState = AuthenticationRegistrationViewState(homeserverAddress: HomeserverAddress.displayable(address: homeserverAddress),
    ...
    func update(homeserverAddress: String, ssoIdentityProviders: [SSOIdentityProvider]) {
        state.homeserverAddress = HomeserverAddress.displayable(address: homeserverAddress)
        state.ssoIdentityProviders = ssoIdentityProviders
    }
    
    func displayError(_ type: AuthenticationRegistrationErrorType) {
        switch type {
