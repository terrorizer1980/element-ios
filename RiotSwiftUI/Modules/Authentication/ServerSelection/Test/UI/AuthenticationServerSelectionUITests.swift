...
class AuthenticationServerSelectionUITests: MockScreenTest {
    ...
    func verifyAuthenticationServerSelectionScreen() throws {
        ...
        case .promptType(let promptType):
            verifyAuthenticationServerSelectionPromptType(promptType: promptType)
        }
    }
    
    func verifyAuthenticationServerSelectionPromptType(promptType: AuthenticationServerSelectionPromptType) {
