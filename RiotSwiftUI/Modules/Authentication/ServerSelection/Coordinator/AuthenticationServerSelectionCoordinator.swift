...
@available(iOS 14.0, *)
@MainActor final class AuthenticationServerSelectionCoordinator: Coordinator, Presentable {
    ...
    var completion: ((AuthenticationServerSelectionCoordinatorResult) -> Void)?
    
    // MARK: - Setup
    
    init(parameters: AuthenticationServerSelectionCoordinatorParameters) {
    ...
    private func useHomeserver(_ homeserverAddress: String) {
        ...
        let homeserverAddress = HomeserverAddress.sanitize(address: homeserverAddress)
