...
@MainActor final class AuthenticationRegistrationCoordinator: Coordinator, Presentable {
    ...
    init(parameters: AuthenticationRegistrationCoordinatorParameters) {
        ...
        do {
            ...
            fatalError("Failed to get the registration wizard, cannot continue: \(error.localizedDescription)")
        }
    ...
    private func createAccount(username: String, password: String) {
        ...
        currentTask = executeRegistrationStep { [weak self] wizard in
            ...
            do {
                ...
                #warning("executeRegistrationStep should throw instead.")
                throw error
            }
        }
    }
    ...
    private func handleError(_ error: Error) {
        ...
        if let authenticationError = error as? AuthenticationError {
            ...
            case .decodingError:
                authenticationRegistrationViewModel.displayError(.invalidResponse)
    ...
    private func serverSelectionCoordinator(_ coordinator: AuthenticationServerSelectionCoordinator,
