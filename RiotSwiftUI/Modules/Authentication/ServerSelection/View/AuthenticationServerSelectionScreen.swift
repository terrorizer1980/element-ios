...
struct AuthenticationServerSelectionScreen: View {
    ...
    var serverForm: some View {
        VStack(alignment: .leading, spacing: 12) {
            RoundedBorderTextField(title: nil,
                                   ...
                                   isError: viewModel.viewState.textFieldError,
            ...
            .disabled(viewModel.homeserverAddress.isEmpty)
        }
    }
    ...
    var emsBanner: some View {
        VStack(spacing: 12) {
            ...
            .buttonStyle(PrimaryActionButtonStyle(customColor: Color(UIColor(rgb: 0x7E69FF))))
        }
        .padding(16)
