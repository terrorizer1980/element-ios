...
class AuthenticationRegistrationUITests: MockScreenTest {
    ...
    func verifyAuthenticationRegistrationScreen() throws {
        ...
        case .presence(let presence):
            verifyAuthenticationRegistrationPresence(presence: presence)
        case .longDisplayName(let name):
            verifyAuthenticationRegistrationLongName(name: name)
        }
    }

    func verifyAuthenticationRegistrationPresence(presence: AuthenticationRegistrationPresence) {
    ...
    func verifyAuthenticationRegistrationLongName(name: String) {
